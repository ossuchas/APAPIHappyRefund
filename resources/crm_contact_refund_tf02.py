...
class CrmContactRefundListTF01Appv(Resource):
    @classmethod
    def get(cls):
        return hyrf_list_schema.dump(CrmContactRefundModel.find_all_tf01_appv()), 200


class CrmContactRefundSearchTF01Appv(Resource):
    @classmethod
    def get(cls, str_search: str):
        return hyrf_list_schema.dump(CrmContactRefundModel.find_txt_search_tf01_appv(str_search)), 200


class CrmContactRefundListTF02(Resource):
    @classmethod
    def get(cls):
        return hyrf_list_schema.dump(CrmContactRefundModel.find_all_tf02_all()), 200


class CrmContactRefundTF02(Resource):
    @classmethod
    ...
    def put(cls, hyrf_id: int):
        ...
        if hyrf:
            ...
            hyrf.tf02_appv_by = item_json["tf02_appv_by"]
